...
function openEditModal(cuenta) {
    ...
    setVal('edit-id-proveedor-hid', cuenta.id_proveedor);
    setVal('edit-cta-proveedor-hid', cuenta.cta_proveedor);
    setVal('edit-proveedor-display', `${cuenta.nom_tercero} — ${cuenta.id_proveedor}`);
    setVal('edit-cta-proveedor-display', cuenta.cta_proveedor);
...
window.eliminarCuenta = function(idProveedor, ctaProveedor, nombreProveedor) {
    ...
    formData.append('hid_del_cta_proveedor', ctaProveedor);
...
document.addEventListener('DOMContentLoaded', function() {
    initBancoxprovModule();
});

function initBancoxprovModule() {
